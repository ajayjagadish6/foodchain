      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.avatar}>
          ...
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>Food Shelter</Text>
          </View>
        </View>
        ...
        <Card style={styles.card}>
          ...
          {user?.orgName && <InfoRow icon="business-outline" label="Organization" value={user.orgName} />}
          {user?.orgAddress && <InfoRow icon="location-outline" label="Address" value={user.orgAddress} />}
        </Card>
